...
// EthereumAPI allows applications to connect to an neura Network node that is
// part of the neura blockchain. Developers can interact with on-chain EVM data
