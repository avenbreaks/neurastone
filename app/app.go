...
import (
	...
	ethante "github.com/avenbreaks/neurastone/app/ante/evm"
	...
	ethermint "github.com/avenbreaks/neurastone/types"
	"github.com/avenbreaks/neurastone/x/evm"
	evmkeeper "github.com/avenbreaks/neurastone/x/evm/keeper"
	evmtypes "github.com/avenbreaks/neurastone/x/evm/types"
	"github.com/avenbreaks/neurastone/x/feemarket"
	feemarketkeeper "github.com/avenbreaks/neurastone/x/feemarket/keeper"
	...
	"github.com/avenbreaks/neurastone/x/epochs"
	epochskeeper "github.com/avenbreaks/neurastone/x/epochs/keeper"
	epochstypes "github.com/avenbreaks/neurastone/x/epochs/types"
	"github.com/avenbreaks/neurastone/x/erc20"
	erc20client "github.com/avenbreaks/neurastone/x/erc20/client"
	erc20keeper "github.com/avenbreaks/neurastone/x/erc20/keeper"
	erc20types "github.com/avenbreaks/neurastone/x/erc20/types"
	"github.com/avenbreaks/neurastone/x/liquidvesting"
	...
	"github.com/avenbreaks/neurastone/x/staking"
	stakingkeeper "github.com/avenbreaks/neurastone/x/staking/keeper"
	"github.com/avenbreaks/neurastone/x/ucdao"
	ucdaokeeper "github.com/avenbreaks/neurastone/x/ucdao/keeper"
	ucdaotypes "github.com/avenbreaks/neurastone/x/ucdao/types"
	"github.com/avenbreaks/neurastone/x/vesting"
	vestingkeeper "github.com/avenbreaks/neurastone/x/vesting/keeper"
	vestingtypes "github.com/avenbreaks/neurastone/x/vesting/types"

	"github.com/avenbreaks/neurastone/precompiles/common"

	v170 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.0"
	v171 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.1"
	v172 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.2"
	v173 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.3"
	v174 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.4"
	v175 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.5"
	v176 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.6"
	v177 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.7"
	v178 "github.com/avenbreaks/neurastone/app/upgrades/v1.7.8"
	v180 "github.com/avenbreaks/neurastone/app/upgrades/v1.8.0"
	v181 "github.com/avenbreaks/neurastone/app/upgrades/v1.8.1"
	v182 "github.com/avenbreaks/neurastone/app/upgrades/v1.8.2"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/avenbreaks/neurastone/x/ibc/transfer"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".neurd")
