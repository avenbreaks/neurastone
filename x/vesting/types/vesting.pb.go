...
// source: neura/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "neura.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("neura/vesting/v1/vesting.proto", fileDescriptor_2567ab5a23894e9c) }
