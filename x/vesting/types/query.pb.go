...
func init() {
	proto.RegisterType((*QueryBalancesRequest)(nil), "neura.vesting.v1.QueryBalancesRequest")
	proto.RegisterType((*QueryBalancesResponse)(nil), "neura.vesting.v1.QueryBalancesResponse")
	proto.RegisterType((*QueryTotalLockedRequest)(nil), "neura.vesting.v1.QueryTotalLockedRequest")
	proto.RegisterType((*QueryTotalLockedResponse)(nil), "neura.vesting.v1.QueryTotalLockedResponse")
}

func init() { proto.RegisterFile("neura/vesting/v1/query.proto", fileDescriptor_741dd5d4fc793cfd) }
...
func (c *queryClient) Balances(ctx context.Context, in *QueryBalancesRequest, opts ...grpc.CallOption) (*QueryBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.vesting.v1.Query/Balances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TotalLocked(ctx context.Context, in *QueryTotalLockedRequest, opts ...grpc.CallOption) (*QueryTotalLockedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.vesting.v1.Query/TotalLocked", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.vesting.v1.Query/Balances",
	}
...
func _Query_TotalLocked_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.vesting.v1.Query/TotalLocked",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "neura.vesting.v1.Query",
	...
	Metadata: "neura/vesting/v1/query.proto",
}
