...
// source: neura/liquidvesting/v1/liquidvesting.proto
...
func init() {
	proto.RegisterType((*Denom)(nil), "neura.liquidvesting.v1.Denom")
}

func init() {
	proto.RegisterFile("neura/liquidvesting/v1/liquidvesting.proto", fileDescriptor_ce2378517a6b5c6c)
}
