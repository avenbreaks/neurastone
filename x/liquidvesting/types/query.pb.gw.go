...
var (
	pattern_Query_Denom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"neura", "liquidvesting", "v1", "denom"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Denoms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"neura", "liquidvesting", "v1", "denoms"}, "", runtime.AssumeColonVerbOpt(false)))
)
