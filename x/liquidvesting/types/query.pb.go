...
// source: neura/liquidvesting/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryDenomRequest)(nil), "neura.liquidvesting.v1.QueryDenomRequest")
	proto.RegisterType((*QueryDenomResponse)(nil), "neura.liquidvesting.v1.QueryDenomResponse")
	proto.RegisterType((*QueryDenomsRequest)(nil), "neura.liquidvesting.v1.QueryDenomsRequest")
	proto.RegisterType((*QueryDenomsResponse)(nil), "neura.liquidvesting.v1.QueryDenomsResponse")
}

func init() { proto.RegisterFile("neura/liquidvesting/v1/query.proto", fileDescriptor_0d414430b780fcf7) }
...
func (c *queryClient) Denom(ctx context.Context, in *QueryDenomRequest, opts ...grpc.CallOption) (*QueryDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.liquidvesting.v1.Query/Denom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Denoms(ctx context.Context, in *QueryDenomsRequest, opts ...grpc.CallOption) (*QueryDenomsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.liquidvesting.v1.Query/Denoms", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Denom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.liquidvesting.v1.Query/Denom",
	}
...
func _Query_Denoms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.liquidvesting.v1.Query/Denoms",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "neura.liquidvesting.v1.Query",
	...
	Metadata: "neura/liquidvesting/v1/query.proto",
}
