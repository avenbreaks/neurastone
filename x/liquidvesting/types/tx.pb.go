...
// source: neura/liquidvesting/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgLiquidate)(nil), "neura.liquidvesting.v1.MsgLiquidate")
	proto.RegisterType((*MsgLiquidateResponse)(nil), "neura.liquidvesting.v1.MsgLiquidateResponse")
	proto.RegisterType((*MsgRedeem)(nil), "neura.liquidvesting.v1.MsgRedeem")
	proto.RegisterType((*MsgRedeemResponse)(nil), "neura.liquidvesting.v1.MsgRedeemResponse")
}

func init() { proto.RegisterFile("neura/liquidvesting/v1/tx.proto", fileDescriptor_cfdce5e8d421730a) }
...
func (c *msgClient) Liquidate(ctx context.Context, in *MsgLiquidate, opts ...grpc.CallOption) (*MsgLiquidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.liquidvesting.v1.Msg/Liquidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Redeem(ctx context.Context, in *MsgRedeem, opts ...grpc.CallOption) (*MsgRedeemResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.liquidvesting.v1.Msg/Redeem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Liquidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.liquidvesting.v1.Msg/Liquidate",
	}
...
func _Msg_Redeem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.liquidvesting.v1.Msg/Redeem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "neura.liquidvesting.v1.Msg",
	...
	Metadata: "neura/liquidvesting/v1/tx.proto",
}
