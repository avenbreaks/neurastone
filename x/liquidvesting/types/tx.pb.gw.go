...
var (
	pattern_Msg_Liquidate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"neura", "liquidvesting", "v1", "tx", "liquidate"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_Redeem_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"neura", "liquidvesting", "v1", "tx", "redeem"}, "", runtime.AssumeColonVerbOpt(false)))
)
