...
import (
	...
	"github.com/avenbreaks/neurastone/ibc"
...
func (k Keeper) OnRecvPacket(
	...
	// Get addresses in `neura1` and the original bech32 format
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	// assume that all module accounts on neura Network need to have their tokens in the
