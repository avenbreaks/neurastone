...
// source: neura/ucdao/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgFund)(nil), "neura.ucdao.v1.MsgFund")
	proto.RegisterType((*MsgFundLegacy)(nil), "neura.ucdao.v1.MsgFundLegacy")
	proto.RegisterType((*MsgFundResponse)(nil), "neura.ucdao.v1.MsgFundResponse")
	proto.RegisterType((*MsgTransferOwnership)(nil), "neura.ucdao.v1.MsgTransferOwnership")
	proto.RegisterType((*MsgTransferOwnershipResponse)(nil), "neura.ucdao.v1.MsgTransferOwnershipResponse")
	proto.RegisterType((*MsgTransferOwnershipWithRatio)(nil), "neura.ucdao.v1.MsgTransferOwnershipWithRatio")
	proto.RegisterType((*MsgTransferOwnershipWithRatioResponse)(nil), "neura.ucdao.v1.MsgTransferOwnershipWithRatioResponse")
	proto.RegisterType((*MsgTransferOwnershipWithAmount)(nil), "neura.ucdao.v1.MsgTransferOwnershipWithAmount")
	proto.RegisterType((*MsgTransferOwnershipWithAmountResponse)(nil), "neura.ucdao.v1.MsgTransferOwnershipWithAmountResponse")
}

func init() { proto.RegisterFile("neura/ucdao/v1/tx.proto", fileDescriptor_0b4b97a33ac1ff40) }
...
func (c *msgClient) Fund(ctx context.Context, in *MsgFund, opts ...grpc.CallOption) (*MsgFundResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Msg/Fund", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TransferOwnership(ctx context.Context, in *MsgTransferOwnership, opts ...grpc.CallOption) (*MsgTransferOwnershipResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Msg/TransferOwnership", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TransferOwnershipWithRatio(ctx context.Context, in *MsgTransferOwnershipWithRatio, opts ...grpc.CallOption) (*MsgTransferOwnershipWithRatioResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Msg/TransferOwnershipWithRatio", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TransferOwnershipWithAmount(ctx context.Context, in *MsgTransferOwnershipWithAmount, opts ...grpc.CallOption) (*MsgTransferOwnershipWithAmountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Msg/TransferOwnershipWithAmount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Fund_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Msg/Fund",
	}
...
func _Msg_TransferOwnership_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Msg/TransferOwnership",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_TransferOwnershipWithRatio_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Msg/TransferOwnershipWithRatio",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_TransferOwnershipWithAmount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Msg/TransferOwnershipWithAmount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "neura.ucdao.v1.Msg",
	...
	Metadata: "neura/ucdao/v1/tx.proto",
}
