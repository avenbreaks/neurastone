...
func init() {
	proto.RegisterType((*QueryBalanceRequest)(nil), "neura.ucdao.v1.QueryBalanceRequest")
	proto.RegisterType((*QueryBalanceResponse)(nil), "neura.ucdao.v1.QueryBalanceResponse")
	proto.RegisterType((*QueryAllBalancesRequest)(nil), "neura.ucdao.v1.QueryAllBalancesRequest")
	proto.RegisterType((*QueryAllBalancesResponse)(nil), "neura.ucdao.v1.QueryAllBalancesResponse")
	proto.RegisterType((*QueryTotalBalanceRequest)(nil), "neura.ucdao.v1.QueryTotalBalanceRequest")
	proto.RegisterType((*QueryTotalBalanceResponse)(nil), "neura.ucdao.v1.QueryTotalBalanceResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "neura.ucdao.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "neura.ucdao.v1.QueryParamsResponse")
	proto.RegisterType((*QueryHoldersRequest)(nil), "neura.ucdao.v1.QueryHoldersRequest")
	proto.RegisterType((*QueryHoldersResponse)(nil), "neura.ucdao.v1.QueryHoldersResponse")
}

func init() { proto.RegisterFile("neura/ucdao/v1/query.proto", fileDescriptor_7deb4626bdb4308f) }
...
func (c *queryClient) Balance(ctx context.Context, in *QueryBalanceRequest, opts ...grpc.CallOption) (*QueryBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Query/Balance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllBalances(ctx context.Context, in *QueryAllBalancesRequest, opts ...grpc.CallOption) (*QueryAllBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Query/AllBalances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TotalBalance(ctx context.Context, in *QueryTotalBalanceRequest, opts ...grpc.CallOption) (*QueryTotalBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Query/TotalBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Holders(ctx context.Context, in *QueryHoldersRequest, opts ...grpc.CallOption) (*QueryHoldersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Query/Holders", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neura.ucdao.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Query/Balance",
	}
...
func _Query_AllBalances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Query/AllBalances",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TotalBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Query/TotalBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Holders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Query/Holders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neura.ucdao.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "neura.ucdao.v1.Query",
	...
	Metadata: "neura/ucdao/v1/query.proto",
}
