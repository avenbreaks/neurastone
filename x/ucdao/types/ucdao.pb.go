...
// source: neura/ucdao/v1/ucdao.proto
...
type AllowedCollateral struct {
	...
	Type CollateralValueType `protobuf:"varint,2,opt,name=type,proto3,enum=neura.ucdao.v1.CollateralValueType" json:"type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("neura.ucdao.v1.CollateralValueType", CollateralValueType_name, CollateralValueType_value)
	proto.RegisterType((*Params)(nil), "neura.ucdao.v1.Params")
	proto.RegisterType((*AllowedCollateral)(nil), "neura.ucdao.v1.AllowedCollateral")
}

func init() { proto.RegisterFile("neura/ucdao/v1/ucdao.proto", fileDescriptor_d93b72bfaafec2b8) }
