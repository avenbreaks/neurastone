...
```log
ok  	github.com/avenbreaks/neurastone/tests/e2e	174.137s.
```
...
Error:  Received unexpected error:
        ...
        github.com/avenbreaks/neurastone/server.StartCmd.func2(0xc001620600?, {0xc0...
            github.com/avenbreaks/neurastone/server/start.go:123 +0x1ec
...
```bash
make test-e2e INITIAL_VERSION=v1.5.0 TARGET_VERSION=v1.6.0
```
