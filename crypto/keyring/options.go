...
import (
	...
	"github.com/avenbreaks/neurastone/ledger"
)

// AppName defines the Ledger app used for signing. neura Network uses the Ethereum app
const AppName = "Ethereum"

var (
	// SupportedAlgorithms defines the list of signing algorithms used on neura Network:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on neura Network for the Ledger device:
	...
	// LedgerDerivation defines the neura Network Ledger Go derivation (Ethereum app with EIP-712 signing)
