...
func (s *PrecompileTestSuite) TestApprove() {
	...
	testCases := []struct {
		...
		{
			"success - MsgDelegate with 1 ISLM as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		{
			"success - MsgUndelegate with 1 ISLM as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		{
			"success - MsgRedelegate with 1 ISLM as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		{
			"success - MsgRedelegate, MsgUndelegate and MsgDelegate with 1 ISLM as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
...
func (s *PrecompileTestSuite) TestDecreaseAllowance() {
	...
	testCases := []struct {
		...
		{
			"success - decrease delegate authorization allowance by 1 ISLM",
			func(_ *vm.Contract) []interface{} {
...
func (s *PrecompileTestSuite) TestIncreaseAllowance() {
	...
	testCases := []struct {
		...
		{
			"success - increase delegate authorization allowance by 1 ISLM",
			func() []interface{} {
