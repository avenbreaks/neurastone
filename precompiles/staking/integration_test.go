...
import (
	...
	compiledcontracts "github.com/avenbreaks/neurastone/contracts"
...
var _ = Describe("Calling staking precompile directly", func() {
	...
	Describe("Execute approve transaction", func() {
		...
		It("should approve the undelegate method with 1 ISLM", func() {
			s.SetupApproval(
		...
		It("should approve the redelegate method with 2 ISLM", func() {
			s.SetupApproval(
		...
		It("should approve the cancel unbonding delegation method with 1 ISLM", func() {
			s.SetupApproval(
	...
	Describe("Execute increase allowance transaction", func() {
		...
		It("Should increase the allowance of the delegate method with 1 ISLM", func() {
			increaseArgs := defaultCallArgs.
				WithMethodName(authorization.IncreaseAllowanceMethod).
				WithArgs(
	...
	Describe("Execute decrease allowance transaction", func() {
		...
		It("Should decrease the allowance of the delegate method with 1 ISLM", func() {
			decreaseArgs := defaultDecreaseArgs.WithArgs(
				s.precompile.Address(), big.NewInt(1e18), []string{staking.DelegateMsg},
			)
