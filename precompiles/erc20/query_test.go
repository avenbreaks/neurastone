...
func (s *PrecompileTestSuite) TestNameSymbol() {
	...
	testcases := []struct {
		name        string
		denom       string
		malleate    func(sdk.Context, *app.Haqq)
		expPass     bool
		errContains string
		expName     string
		expSymbol   string
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.Haqq) {
...
func (s *PrecompileTestSuite) TestTotalSupply() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.Haqq, *big.Int)
		expPass     bool
		errContains string
		expTotal    *big.Int
	}{
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.Haqq, amount *big.Int) {
				// NOTE: we mint some coins to the inflation module address to be able to set denom metadata
...
func (s *PrecompileTestSuite) TestBalanceOf() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.Haqq, *big.Int) []interface{}
		expPass     bool
		errContains string
		expBalance  *big.Int
	}{
		{
			...
			malleate: func(_ sdk.Context, _ *app.Haqq, _ *big.Int) []interface{} {
				return []interface{}{}
			},
